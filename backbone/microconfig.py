...
# The rest three parameters are used to decide whether the dynamic shift-max is used or not, 
# while the last parameter is the hyperparameter contained in dynamic shift-max to adjust the reduction ratio.
